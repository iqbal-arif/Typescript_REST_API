...
var admin_only_middleware_1 = require("./middlewares/admin_only.middleware");
// CORS Package
...
function setupExpress() {
    ...
    app.route('/api/users').post(authentication_middleware_1.checkIfAuthenticated, admin_only_middleware_1.checkIfAdmin, create_users_1.createUser);
