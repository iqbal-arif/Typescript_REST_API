...
function deleteCourseAndLessons(request, response, next) {
    return __awaiter(this, void 0, void 0, function () {
        var courseId_1, error_1;
        var _this = this;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    courseId_1 = request.params.courseId;
                    if (!(0, utils_1.isInteger)(courseId_1)) {
                        throw "Invalid courseId ".concat(courseId_1);
                    }
                    return [4 /*yield*/, data_source_1.AppDataSource.manager.transaction(function (transactionalEntityManager) { return __awaiter(_this, void 0, void 0, function () {
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0: return [4 /*yield*/, transactionalEntityManager
                                            .createQueryBuilder()
                                            .delete()
                                            .from(lesson_1.Lesson)
                                            .where('courseId = :courseId', { courseId: courseId_1 })
                                            .execute()];
                                    case 1:
                                        _a.sent();
                                        return [4 /*yield*/, transactionalEntityManager
                                                ...
                                                .where('id = :courseId', { courseId: courseId_1 })
                                                .execute()];
                                    case 2:
                                        _a.sent();
                                        return [2 /*return*/];
