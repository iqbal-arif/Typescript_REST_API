...
8. Now Get Courses with the same JSONWEBTOKEN 1. curl http://localhost:9001/api/courses - H "Authorization: ENTER JSONWEBTOKEN"
   curl http://localhost:9001/api/courses -H "Authorization: eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOjEsImVtYWlsIjoidGVzdEBhbmd1bGFyLXVuaXZlcnNpdHkuaW8iLCJpc0FkbWluIjpmYWxzZSwiaWF0IjoxNjc2MDg3MDA4fQ.Z68uKrUEXJvLcu_i59QJDaHw06i5kBdEBy6SY6qfPeA" 2. Results
